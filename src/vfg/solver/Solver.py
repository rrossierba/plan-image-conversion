...
from vfg.extension import Custom_functions#, Subgoal
import Initialise
...
def get_visualisation_dic(predicates, animation_profile, problem_dic, actionlist=None):
    """
    ...
    :param actionlist: list of action to achieve the goals
